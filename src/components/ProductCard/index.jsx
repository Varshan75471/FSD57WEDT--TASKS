...
export default function ProductCard({
  ...
  function renderRatings(rating = 0) {
    ...
    for (let i = 0; i < rating; i++) {
      ratingsNode.push(<div className="bi-star-fill" key={i}></div>);
    }
    return ratingsNode;
  }
        ...
        <div className="card-footer p-4 pt-0 border-top-0 bg-transparent">
          <div className="text-center">
            <button
              ...
              onClick={() => isAddedToCart ? handleRemoveFromCart(data) : handleAddToCart(data)}
            >
...
ProductCard.propTypes = {
  ...
  handleRemoveFromCart: PropTypes.func.isRequired, // Add this prop type
